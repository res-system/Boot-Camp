...
///////////////////////////////////
// 2018.12.20
          this.currentViewMode = Math.max(this._options.MinViewModeNumber, Math.min(3, this.currentViewMode + dir));
///////////////////////////////////
...
// 2018.12.20
        ...
        if (this._isEnabled('y')) { this._options.MinViewModeNumber = 2; }
        if (this._isEnabled('M')) { this._options.MinViewModeNumber = 1; }
        if (this._isEnabled('d')) { this._options.MinViewModeNumber = 0; }
        this.currentViewMode = Math.max(this._options.MinViewModeNumber, this.currentViewMode);
///////////////////////////////////
...
///////////////////////////////////
// 2018.12.20
        this.currentViewMode = Math.max(DateTimePicker.ViewModes.indexOf(_viewMode) - 1, this._options.MinViewModeNumber);
///////////////////////////////////
...
///////////////////////////////////
// 2018.12.20
        return this._options.MinViewModeNumber;
///////////////////////////////////
...
///////////////////////////////////
// 2018.12.20
              if (this.currentViewMode === this._options.MinViewModeNumber) {
///////////////////////////////////
...
///////////////////////////////////
// 2018.12.20
        if (this._options.viewMode !== 'months') {
          this.currentViewMode = 0;
        }
///////////////////////////////////
        if (this.input !== undefined) {
