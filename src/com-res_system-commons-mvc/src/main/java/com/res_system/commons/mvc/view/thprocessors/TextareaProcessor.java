 ...
 * @author res.
 */
public class TextareaProcessor extends AbstractAttributeTagProcessor {

    private static final String ATTR_NAME = "textarea";
    private static final int PRECEDENCE = 10000;

    public TextareaProcessor(final String dialectPrefix) {
        super(
