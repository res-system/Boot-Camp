 ...
 * @author res.
 */
public class UqHrefProcessor extends AbstractAttributeTagProcessor {

    private static final String ATTR_NAME = "uqhref";
    private static final int PRECEDENCE = 10000;

    public UqHrefProcessor(final String dialectPrefix) {
        super(
    ...
    protected void doProcess(
        ...
        structureHandler.setAttribute("href", value + "?ver=" + version);
    }
