 ...
 */
@RequestScoped
public class EmployeeExpensesModel {
     ...
     * @throws Exception
     */
    public boolean find(final EmployeeExpensesForm form) throws Exception {
        boolean result = true;
        return result;
    }
     ...
     */
    public void setShowFormData(final EmployeeExpensesForm form) throws SimpleDaoException {
