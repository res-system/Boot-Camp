...
public class SelectGroupForm {
    ...
    /** 入力データ. */
    @DataParam
    private SelectGroupMGroup data;
    /** 検索条件. */
    @DataParam
    private SearchCondition searchCond;
    /** 取得リスト. */
    @ListParam(SelectGroupMGroup.class)
    private List<SelectGroupMGroup> list;
    /** 取得リストサイズ. */
    @Param
    ...
    //-- setter / getter. --//
    /** 入力データ を取得します. */
    public SelectGroupMGroup getData() { return data; }
    /** 入力データ を設定します. */
    public void setData(SelectGroupMGroup data) { this.data = data; }
    /** 検索条件 を取得します. */
    ...
    /** 取得リスト を取得します. */
    public List<SelectGroupMGroup> getList() { return list; }
    /** 取得リスト を設定します. */
    public void setList(List<SelectGroupMGroup> list) { this.list = list; }
    /** 取得リストサイズ を取得します. */
