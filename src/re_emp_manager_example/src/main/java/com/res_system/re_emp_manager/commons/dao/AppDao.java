...
public class AppDao extends SimpleDao {
     ...
     * @throws SimpleDaoException
     */
    public long getLongCount(final String sql, ISetStatementParam st) throws SimpleDaoException {
        Map<String, String> result = executeQueryMap(sql, st);
        if (!ReUtil.isEmpty(result)) {
            return ReUtil.toLong(result.get("count"), 0L);
        }
        return 0L;
    }
     ...
     * @throws SimpleDaoException
     */
    public String getString(final String name, final String sql, ISetStatementParam st) throws SimpleDaoException {
        Map<String, String> result = executeQueryMap(sql, st);
        if (!ReUtil.isEmpty(result)) {
     ...
     * @throws SimpleDaoException
     */
    public String getString(final String name, final String sql) throws SimpleDaoException {
        return getString(name, sql, null);
    }
