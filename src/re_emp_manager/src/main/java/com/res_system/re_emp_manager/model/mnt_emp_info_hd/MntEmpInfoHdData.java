...
@Sqls({
    ...
    ,@Sql(name="find_list_order_7", sql = "ORDER BY `required_name` ASC ")
    ,@Sql(name="find_list_order_8", sql = "ORDER BY `required_name` DESC ")
    ,@Sql(name="find_list_order_9", sql = "ORDER BY `maxlength` ASC ")
    ,@Sql(name="find_list_order_10", sql = "ORDER BY `maxlength` DESC ")
    ,@Sql(name="find_list_order_11", sql = "ORDER BY `status_name` ASC ")
    ,@Sql(name="find_list_order_12", sql = "ORDER BY `status_name` DESC ")
