...
public class AuthModelTest {
    ...
    public void doLoginTest() throws Exception {
        ...
        try {
            ...
            {
                msg = "[ OK(グループ(アカウントあり (res-system.com,test@res-system.com) )) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "test@res-system.com", "test1234", false));
                System.out.println(testinfo + msg + " -- OK -- ");
                {
                    TLogin entity = new TLogin();
                    entity.setToken(target.getToken());
            ...
            {
                msg = "[ OK(グループ(アカウントあり (res-system.com,group-ab@res-system.com) )) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "group-ab@res-system.com", "test1234", false));
                System.out.println(testinfo + msg + " -- OK -- ");
                {
                    TLogin entity = new TLogin();
                    entity.setToken(target.getToken());
            ...
            {
                msg = "[ OK(グループ(アカウントあり (group-b.com,group-ab@res-system.com) )) ]";
                assertEquals(msg, true, target.doLogin("group-b.com", "group-ab@res-system.com", "test1234", false));
                System.out.println(testinfo + msg + " -- OK -- ");
                {
                    TLogin entity = new TLogin();
                    entity.setToken(target.getToken());
            ...
            {
                msg = "[ OK(グループ(アカウントなし (res-system.com,member02) )) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "member02", "test1234", false));
                System.out.println(testinfo + msg + " -- OK -- ");
                {
                    TLogin entity = new TLogin();
                    entity.setToken(target.getToken());
            ...
            {
                msg = "[ OK(グループリーダー (res-system.com,member02) ) ]";
    ...
    public void isPermissionTest() throws Exception {
        ...
        try {
            ...
            {
                msg = "[ OK(グループオーナー) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "test@res-system.com", "test1234", true));
                assertEquals(msg, true, target.isPermission("main_menu"));
            ...
            {
                msg = "[ OK(グループメンバー) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "member05", "test1234", true));
                assertEquals(msg, true, target.isPermission("main_menu"));
                assertEquals(msg, false, target.isPermission("change_account_name"));
                assertEquals(msg, true, target.isPermission("change_password"));
                assertEquals(msg, false, target.isPermission("emp_search"));
    ...
    public void checkGroupIdTest() throws Exception {
        ...
        try {
            ...
            {
                msg = "[ OK (res-system.com,member02) ]";
                assertEquals(msg, true, target.doLogin("res-system.com", "member04", "test1234", false));
