...
//
//            //-- OK. --//
//            assertEquals(msg, true, auth.doLogin("kutanik@res-system.com", "test1234", false));
//            {
//                msg = testinfo + "[ OK ]";
...
//            }
//            assertEquals(msg, true, auth.doLogin("k.kutakuta@gmail.com", "test1234", false));
//            {
//                msg = testinfo + "[ OK ]";
//                MAccount entity = new MAccount();
//                target.setUpdateInfo(entity);
//                assertEquals(msg, "2", entity.getCreated_id());
//                assertEquals(msg, "2", entity.getUpdated_id());
//                System.out.println(msg + " -- OK -- ");
//                SandBox.showObject(msg, entity);
//            }
//            auth.clearLogin();
...
//        String testinfo = "reissuePassword() :";
//        System.out.println(testinfo + "** Start ****************");
//        String msg = "";
//        try {
//            dao.setNonCommit(true);
...
//
//            //-- OK. --//
//            assertEquals(msg, true, auth.doLogin("kutanik@res-system.com", "test1234", true));
//            {
//                String account_id = "2";
//                msg = testinfo + "[ OK(" + account_id + ") ]";
//                boolean actual = target.reissuePassword(account_id);
//                assertEquals(msg, true, actual);
//                {
//                    // 確認.
//                    MAccount entity = dao.findByKey(MAccount.class, account_id);
//                    SandBox.showObject(msg, entity);
//                }
//                System.out.println(msg + " -- OK -- ");
//            }
