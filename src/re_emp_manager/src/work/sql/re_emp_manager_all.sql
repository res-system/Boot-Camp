...
-- 
-- アカウント連携関連マスタ `r_acc_cooperation`
-- generated at 2018/09/21. 
-- 
DROP TABLE IF EXISTS `r_acc_cooperation`;
CREATE TABLE `r_acc_cooperation` (
...
,`created_id` BIGINT(20) UNSIGNED DEFAULT 1 NOT NULL COMMENT '作成者ID'
,`created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '作成日時'
,PRIMARY KEY(`account_id`,`root_group_id`,`user_id`)
) ENGINE = InnoDB COMMENT='アカウント連携関連マスタ';
...
,`kbn` VARCHAR(100) NULL COMMENT '区分'
,`updated_id` BIGINT(20) UNSIGNED DEFAULT 1 NOT NULL COMMENT '更新者ID'
,`updated` TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '更新日時'
,`created_id` BIGINT(20) UNSIGNED DEFAULT 1 NOT NULL COMMENT '作成者ID'
,`created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '作成日時'
...
ALTER TABLE r_acc_cooperation DROP FOREIGN KEY IF EXISTS r_acc_cooperation_account_id; ALTER TABLE r_acc_cooperation ADD CONSTRAINT r_acc_cooperation_account_id FOREIGN KEY (account_id) REFERENCES m_account(id);
ALTER TABLE r_acc_cooperation DROP FOREIGN KEY IF EXISTS r_acc_cooperation_root_group_id; ALTER TABLE r_acc_cooperation ADD CONSTRAINT r_acc_cooperation_root_group_id FOREIGN KEY (root_group_id) REFERENCES m_group(id);
ALTER TABLE r_acc_cooperation DROP FOREIGN KEY IF EXISTS r_acc_cooperation_user_id; ALTER TABLE r_acc_cooperation ADD CONSTRAINT r_acc_cooperation_user_id FOREIGN KEY (user_id) REFERENCES m_user(id);
